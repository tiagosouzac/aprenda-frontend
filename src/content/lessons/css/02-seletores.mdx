...
quiz:
  ...
  - question: "Qual é a diferença entre :first-child e :first-of-type?"
    options:
      ...
      - ":first-child funciona apenas com parágrafos; :first-of-type com qualquer elemento"
      - ":first-child é mais específico que :first-of-type"
