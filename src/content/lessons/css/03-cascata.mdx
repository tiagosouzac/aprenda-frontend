...
quiz:
  ...
  - question: "O que o valor 'unset' faz em uma propriedade CSS?"
    options:
      - "Remove por completo aquela declaração da regra, como se ela nunca tivesse sido escrita pelo desenvolvedor no código CSS"
      - "Herda o valor se a propriedade é herdável; usa o valor inicial da especificação se não for"
      - "Reseta o valor daquela propriedade para zero em qualquer situação possível, independentemente de qual propriedade ela seja"
      - "É exatamente equivalente ao uso do valor 'initial' quando ele é aplicado a absolutamente todas as propriedades do CSS"
    correct: 1
---
