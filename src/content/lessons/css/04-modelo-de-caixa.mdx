...
quiz:
  ...
  - question: "O que acontece com as margens de dois parágrafos adjacentes, cada um com margin: 16px?"
    options:
      - "O espaço total entre os dois parágrafos passa a ser de 32px, ou seja, a soma exata das duas margens de cada um deles"
      - "O espaço total entre os dois parágrafos passa a ser de 8px, que corresponde à média aritmética entre as duas margens"
      - "O resultado depende totalmente de qual navegador está sendo usado para renderizar aquela página naquele exato momento"
  ...
  - question: "Qual é a diferença entre padding e margin?"
    options:
      - "O padding cria o espaço externo do elemento, enquanto a margin é a responsável por criar o espaço interno dele na caixa"
      - "Padding cria espaço interno entre conteúdo e borda; margin cria espaço externo entre a borda e outros elementos"
      - "O padding afeta diretamente a cor de fundo do elemento, enquanto a margin não tem nenhuma influência sobre esse fundo"
      - "Não existe diferença prática nenhuma entre o padding e a margin: a diferença entre os dois está apenas no nome de cada um"
    correct: 1
---
