...
quiz:
  - question: "O que significa dizer que um elemento é display: block?"
    options:
      ...
      - "Ele ocupa apenas o espaço exato do seu próprio conteúdo e continua fluindo na mesma linha junto com o texto que está ao redor"
      - "Ele é removido por completo do layout da página, deixando de ocupar qualquer espaço que fosse visível dentro do documento"
      - "Ele passa a ser posicionado sempre em relação à viewport do navegador, e não mais em relação ao seu elemento pai na página"
    correct: 0
  - question: "Por que margin-top e margin-bottom não funcionam em elementos inline?"
    options:
      - "Na verdade isso é um bug do próprio navegador: as margens verticais deveriam funcionar normalmente nos elementos inline também"
      - "Porque os elementos inline simplesmente não possuem nenhum modelo de caixa ao seu redor, ao contrário dos elementos block"
      - "Porque margens verticais em inline não deslocam vizinhos — o elemento flui com o texto e não pode criar espaço vertical"
      - "Porque a propriedade margin só consegue funcionar de fato quando ela é aplicada a elementos que estão com position: absolute"
    correct: 2
  - question: "Qual é a diferença entre display: none e visibility: hidden?"
    options:
      - "Não existe diferença alguma entre os dois: tanto o display: none quanto o visibility: hidden produzem exatamente o mesmo efeito"
      - "O display: none é uma opção bem mais acessível para os leitores de tela do que o uso da propriedade visibility: hidden na página"
      - "O visibility: hidden remove o elemento por completo do layout, enquanto o display: none apenas o esconde mas mantém o espaço dele"
