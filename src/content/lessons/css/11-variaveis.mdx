...
quiz:
  ...
  - question: "Por que definir custom properties em :root é recomendado para design tokens?"
    options:
      - "Porque :root tem especificidade mais alta que outros seletores"
      - "Porque apenas :root pode conter custom properties"
      ...
      - "Porque :root é necessário para o JavaScript acessar as variáveis"
    correct: 2
  - question: "O que acontece quando você redefine uma custom property dentro de um seletor filho?"
    options:
      - "Causa um erro — custom properties não podem ser redefinidas"
      - "A redefinição substitui o valor original em toda a página"
      - "A redefinição é ignorada se a propriedade já foi definida em :root"
  ...
  - question: "Qual é a vantagem de usar custom properties para implementar tema escuro, em vez de redeclarar todas as propriedades de cor?"
    options:
      - "Custom properties são mais rápidas de processar em modo escuro"
      ...
      - "É a única forma de implementar modo escuro sem JavaScript"
      - "Reduz o número de media queries necessárias"
    correct: 1
---
