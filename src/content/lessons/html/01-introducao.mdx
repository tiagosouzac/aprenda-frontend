...
quiz:
  ...
  - question: "Por que HTML bem escrito importa mesmo que a página pareça igual?"
    options:
      ...
      - "Não importa de verdade: no fim das contas, o único resultado que realmente conta para o usuário é o aspecto visual da página"
      - "Porque o navegador simplesmente se recusa a renderizar qualquer página cujo HTML tenha sido escrito de forma incorreta ou inválida"
      - "Porque o CSS da página não consegue funcionar de jeito nenhum se o HTML que está por baixo dele não estiver totalmente correto"
    correct: 0
---
