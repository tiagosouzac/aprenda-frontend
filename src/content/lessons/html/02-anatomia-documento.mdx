...
quiz:
  - question: "Para que serve o <!DOCTYPE html> no início de um arquivo HTML?"
    options:
      - "Serve para importar a folha de estilos CSS padrão que o próprio navegador aplica a todos os elementos da página por padrão"
      - "Serve para definir qual é o idioma principal do documento, ajudando o navegador e os leitores de tela a interpretá-lo"
      - "Para declarar que o documento usa HTML5 e ativar o modo padrão de renderização"
      - "Serve para estabelecer a conexão inicial entre o arquivo HTML e o servidor web que está hospedando aquele site na internet"
    correct: 2
  - question: "Por que o atributo lang no elemento html é importante?"
    options:
      - "Serve para definir qual é a versão exata do HTML que está sendo usada naquele documento, como o HTML5 ou versões anteriores"
      - "É um atributo totalmente obrigatório, sem o qual o CSS aplicado à página simplesmente não consegue funcionar de forma correta"
      - "Serve para bloquear o acesso à página de usuários que estejam em outros países que falam um idioma diferente do informado"
  ...
  - question: "Qual é o efeito de omitir meta charset='utf-8'?"
    options:
      - "A página inteira simplesmente não carrega no navegador, exibindo no lugar dela uma tela de erro em branco para o usuário"
      - "Caracteres especiais como acentos podem ser exibidos incorretamente"
      - "Toda a folha de estilos CSS da página para de funcionar e o conteúdo passa a ser exibido sem nenhuma formatação visual"
      - "O código JavaScript da página deixa de ser executado pelo navegador, e nenhuma interação da página passa a funcionar"
    correct: 1
