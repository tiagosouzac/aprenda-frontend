...
quiz:
  ...
  - question: "Qual é o uso correto de br?"
    options:
      - "Serve para criar espaço vertical entre dois parágrafos, empurrando o conteúdo seguinte um pouco mais para baixo na página"
      - "Serve para separar visualmente seções diferentes de conteúdo dentro de uma mesma página, como faz uma linha divisória"
      - "Serve para substituir o elemento de parágrafo p em trechos de texto que sejam considerados mais curtos dentro do documento"
  ...
  - question: "Qual é a diferença semântica entre strong e b?"
    options:
      - "Não existe diferença alguma entre os dois: tanto o strong quanto o b apenas deixam o texto que envolvem em negrito na tela"
      - "strong indica importância semântica; b é apenas estilístico, sem semântica"
      - "O elemento b é usado para destacar palavras isoladas, enquanto o elemento strong é usado para destacar frases inteiras"
      - "O strong consegue funcionar sem nenhum CSS aplicado, enquanto o b só passa a ter algum efeito visual quando há CSS na página"
    correct: 1
