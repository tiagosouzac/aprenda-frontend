...
quiz:
  - question: "O que é uma URL relativa?"
    options:
      - "Uma URL que usa o protocolo https"
      - "Uma URL que muda dependendo do usuário"
      - "Uma URL definida em relação ao documento atual, sem incluir protocolo ou domínio"
      - "Uma URL temporária que expira após um tempo"
    correct: 2
  - question: "Por que usar rel='noopener noreferrer' junto com target='_blank'?"
    options:
      - "Para melhorar a velocidade de carregamento da nova aba"
      - "Para garantir que a nova aba herda os estilos CSS da página original"
      - "Para que o link funcione em navegadores mais antigos"
  ...
  - question: "Como funciona um link âncora como href='#aprendizados'?"
    options:
      - "Abre uma nova página chamada aprendizados"
      - "Rola a página até o elemento com id='aprendizados' na mesma página"
      - "Cria um marcador no navegador"
      - "Aplica um estilo especial ao elemento de destino"
    correct: 1
  - question: "Por que 'clique aqui' é um texto de link problemático?"
    options:
      ...
      - "Porque é muito curto para o navegador processar"
      - "Porque não funciona com target='_blank'"
      - "Porque mecanismos de busca ignoram links com esse texto"
    correct: 0
---
