...
quiz:
  - question: "O que é HTML semântico?"
    options:
      - "É o HTML que utiliza apenas as tags mais modernas que foram introduzidas na versão HTML5 da linguagem de marcação"
      - "É o HTML escrito de uma forma que evita por completo o uso dos elementos genéricos div e span em qualquer parte da página"
      - "HTML que usa elementos que descrevem o papel e o significado do conteúdo, não apenas sua aparência"
      - "É o HTML cuja estrutura de elementos segue obrigatoriamente um sistema de layout baseado em grid de linhas e de colunas"
    correct: 2
  ...
  - question: "Qual é a diferença entre article e section?"
    options:
      - "Não existe nenhuma diferença prática entre os dois elementos: tanto faz usar o article ou o section em qualquer situação"
      - "article é para conteúdo independente que faz sentido fora do contexto; section é para agrupamento temático"
      - "O elemento article só pode ser usado quando ele está colocado dentro de um elemento section, e nunca de forma isolada na página"
      - "O elemento section serve para conteúdos mais longos, enquanto o elemento article serve apenas para conteúdos mais curtos"
    correct: 1
  - question: "Quando usar div em vez de um elemento semântico?"
    options:
      - "Quando nenhum elemento semântico descreve o papel do contêiner"
      - "Nunca se deve usar a div, porque o elemento div foi considerado obsoleto e acabou sendo removido na versão HTML5 da linguagem"
      - "Deve-se usar a div sempre que você precisar de um contêiner de bloco qualquer para agrupar outros elementos dentro da página"
      - "Deve-se usar a div especificamente quando aquele elemento de contêiner vai precisar receber algum tipo de estilização com CSS"
    correct: 0
---
