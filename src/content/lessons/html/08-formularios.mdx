...
quiz:
  - question: "Qual é a diferença entre os métodos GET e POST em um formulário?"
    options:
      - "GET é mais seguro; POST é mais rápido"
      - "GET funciona sem JavaScript; POST precisa de JavaScript"
      - "GET envia os dados na URL; POST os envia no corpo da requisição"
      - "GET é para formulários simples; POST é para formulários com mais de três campos"
    correct: 2
  - question: "Por que o label é essencial em formulários?"
    options:
      - "Para estilizar o campo com CSS"
      - "Para aumentar a área clicável em torno do input"
      - "Para que o JavaScript consiga encontrar o campo"
  ...
  - question: "O que o atributo required faz em um input?"
    options:
      - "Marca o campo como somente leitura"
      - "Impede o envio do formulário se o campo estiver vazio"
      - "Aplica um estilo visual de destaque ao campo"
      - "Pré-preenche o campo com um valor padrão"
    correct: 1
  - question: "Qual é a vantagem de usar button type='submit' em vez de input type='submit'?"
    options:
      ...
      - "É obrigatório no HTML5"
      - "Funciona sem JavaScript"
      - "Envia o formulário mais rapidamente"
    correct: 0
---
