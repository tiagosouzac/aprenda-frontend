...
quiz:
  - question: "Qual é a principal diferença entre JavaScript e HTML/CSS?"
    options:
      - "JavaScript é uma tecnologia bem mais recente que o HTML e o CSS, criada depois para complementar as duas em projetos modernos"
      - "JavaScript roda apenas no servidor que hospeda o site e nunca diretamente dentro do navegador do usuário final que acessa a página"
      - "JavaScript executa — ele tem estado, controle de fluxo e pode produzir resultados diferentes dependendo de quando é chamado"
      - "JavaScript veio para substituir o HTML na tarefa de descrever a estrutura e o conteúdo de cada página de um site na web"
    correct: 2
  - question: "O que é Node.js?"
    options:
      - "Um navegador inteiro construído sobre JavaScript, usado para abrir páginas da web direto a partir da linha de comando do sistema"
      - "Uma versão mais rápida e otimizada da própria linguagem JavaScript, criada para rodar cálculos pesados dentro do navegador"
      - "Uma biblioteca JavaScript voltada para a construção de interfaces gráficas e de componentes visuais reutilizáveis na tela"
  ...
  - question: "Por que typeof null retorna 'object' em JavaScript?"
    options:
      - "Porque o null é considerado um tipo especial de objeto pela própria especificação oficial da linguagem JavaScript"
      - "É um bug histórico dos primeiros dias da linguagem que não pode ser corrigido sem quebrar código existente"
      - "Porque o valor null herda suas propriedades diretamente de Object através da cadeia de protótipos da linguagem"
      - "Porque, em JavaScript, todos os valores de tipos primitivos acabam retornando a string 'object' quando passam por typeof"
    correct: 1
  - question: "O que foi ES6/ES2015?"
    options:
      ...
      - "Foi a primeira versão do JavaScript de todas, lançada lá em 1995 junto com o navegador Netscape Navigator"
      - "Foi a versão do JavaScript responsável por adicionar o ambiente Node.js e a execução da linguagem fora do navegador"
      - "Foi uma biblioteca JavaScript bastante popular, criada especificamente para facilitar a manipulação do DOM nas páginas"
    correct: 0
---
