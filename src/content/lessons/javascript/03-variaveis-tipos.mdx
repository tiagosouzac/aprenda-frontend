...
quiz:
  - question: "Quando usar let em vez de const?"
    options:
      - "Quando a variável contém um array ou objeto"
      - "Quando a variável está dentro de uma função"
      - "Quando o valor precisa ser reatribuído depois da declaração — const não permite reatribuição"
      - "Quando o tipo do valor pode mudar"
    correct: 2
  - question: "Qual é a diferença entre null e undefined em JavaScript?"
    options:
      - "Não há diferença — são sinônimos"
      - "null é um número; undefined é uma string"
      - "undefined é mais moderno e deve substituir null"
  ...
  - question: "Por que '5' + 3 resulta em '53' mas '5' - 3 resulta em 2?"
    options:
      ...
      - "Porque 5 e 3 são coercidos para strings diferentes em cada caso"
      - "Porque + tem precedência maior que -"
    correct: 1
