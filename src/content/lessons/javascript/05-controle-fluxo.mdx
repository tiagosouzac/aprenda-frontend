...
quiz:
  ...
  - question: "Por que for...of é preferível ao for clássico na maioria dos casos?"
    options:
      - "for...of é mais rápido"
      - "for...of funciona com mais tipos de dados"
      - "for clássico não funciona com arrays modernos"
  ...
  - question: "O que acontece em um switch sem break em cada case?"
    options:
      - "O JavaScript gera um erro de sintaxe"
      - "Fall-through: a execução continua para o próximo case sem verificar a condição — até encontrar um break ou o fim do switch"
      - "Apenas o primeiro case é executado"
      - "O switch ignora os cases sem break automaticamente"
    correct: 1
  - question: "O que é retorno antecipado em uma função e por que é preferível ao aninhamento de if/else?"
    options:
      ...
      - "Retornar undefined ao invés de um valor"
      - "Uma técnica para tornar a função mais rápida"
      - "Retornar o valor antes de todos os cálculos estarem completos"
    correct: 0
---
