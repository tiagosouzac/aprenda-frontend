...
quiz:
  - question: "Qual é a vantagem de template literals (backticks) sobre concatenação com +?"
    options:
      - "Template literals são mais rápidos"
      - "Template literals funcionam apenas com variáveis simples, não com expressões"
      ...
      - "Template literals só funcionam com strings — não com números"
    correct: 2
  - question: "O que slice(-3) retorna em uma string?"
    options:
      - "Os três primeiros caracteres"
      - "Um erro — slice não aceita índices negativos"
      - "A string sem os três últimos caracteres"
  ...
  - question: "Por que strings são imutáveis em JavaScript?"
    options:
      - "É uma limitação que será corrigida em versões futuras"
      ...
      - "Porque strings compartilham referência como objetos"
      - "Porque o JavaScript usa UTF-8 internamente"
    correct: 1
  - question: "O que split('') faz em uma string?"
    options:
      ...
      - "Converte a string para um array de códigos ASCII"
    correct: 0
---
