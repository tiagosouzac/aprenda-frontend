...
quiz:
  ...
  - question: "O que acontece quando await é usado em uma Promise que rejeita?"
    options:
      ...
      - "A execução continua normalmente com valor undefined"
      - "A função async retorna null"
  ...
  - question: "Qual é o problema de usar await dentro de um loop for...of com múltiplas operações independentes?"
    options:
      - "await não funciona dentro de for...of"
      ...
      - "Não há problema — é o padrão recomendado"
    correct: 1
  - question: "Qual é a vantagem de async/await sobre .then().catch()?"
    options:
      ...
      - "async/await é mais rápido"
      - "async/await não precisa de try/catch"
      - "async/await funciona em mais navegadores"
    correct: 0
---
