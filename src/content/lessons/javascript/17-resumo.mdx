...
quiz:
  - question: "Por que usar const por padrão em vez de let?"
    options:
      - "Porque const é mais rápido que let"
      - "Porque let foi descontinuado no ES2020"
      ...
      - "Apenas uma convenção sem impacto real"
    correct: 2
  - question: "Por que dados do usuário nunca devem ir para innerHTML?"
    options:
      - "Porque innerHTML não aceita texto"
      - "Porque innerHTML é mais lento que textContent"
      - "Porque innerHTML só funciona em divs"
  ...
  - question: "Por que event delegation é preferível a N listeners individuais?"
    options:
      - "Porque o navegador processa um listener mais rápido"
      ...
      - "Porque addEventListener tem limite de N listeners por elemento"
      - "Não há vantagem real — é apenas uma preferência de estilo"
    correct: 1
  - question: "Qual é o problema de await sequencial desnecessário?"
    options:
      ...
      - "await sequencial não funciona em todos os navegadores"
      - "O código fica mais difícil de ler"
      - "Não há problema — await sequencial é sempre preferível"
    correct: 0
---
