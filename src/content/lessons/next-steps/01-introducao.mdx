...
quiz:
  - question: "O que o conhecimento de HTML, CSS e JavaScript juntos permite fazer que cada um separado não permite?"
    options:
      ...
      - "Publicar aplicativos em lojas de aplicativo"
  ...
  - question: "Por que TypeScript foi introduzido depois de JavaScript no curso, e não antes?"
    options:
      - "TypeScript é mais difícil e requer mais experiência"
      - "TypeScript e JavaScript são linguagens independentes"
      - "TypeScript só é útil com React"
  ...
  - question: "O que o curso não cobriu e que faz parte do desenvolvimento web real?"
    options:
      ...
      - "Como escrever HTML, CSS e JavaScript"
      - "Como usar o devtools do browser"
    correct: 1
---
