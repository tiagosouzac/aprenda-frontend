...
quiz:
  - question: "Qual é a principal diferença de modelo mental entre Vue e React?"
    options:
      - "Vue usa templates com diretivas e reatividade por proxies; React usa JSX e hooks"
      - "O Vue usa JavaScript puro e o React exige o uso de TypeScript em tudo"
      - "O Vue é sempre mais rápido de executar do que o React puro"
      - "O Vue não possui nenhum sistema de componentes, ao contrário do React"
    correct: 0
  - question: "O que torna o Svelte diferente de React e Vue em termos de arquitetura?"
    options:
      - "O Svelte não possui nenhum conceito de componentes, diferente de React e Vue"
      - "O Svelte exige o uso de TypeScript em todos os componentes do projeto"
      - "Svelte é um compilador: gera JS puro sem runtime no browser; React e Vue enviam um runtime"
      - "O Svelte só funciona em conjunto com renderização no servidor (SSR)"
    correct: 2
  - question: "Por que conhecer outras bibliotecas além do React vale a pena?"
    options:
      - "Para poder usar qualquer framework do mercado em qualquer projeto novo"
      - "Porque o mercado exige conhecer absolutamente todas as bibliotecas existentes"
      - "Porque a previsão é que o React seja descontinuado pela comunidade em breve"
      - "Para enxergar o que é essencial e o que é só convenção do React"
    correct: 3
  - question: "O que é reatividade granular no Solid.js?"
    options:
      - "Uma forma de re-renderizar o componente inteiro de uma vez mais rápido"
      - "Atualiza só o nó do DOM que mudou, sem re-executar o componente inteiro (ao contrário do React)"
      - "Uma técnica de memoização automática que faz cache de cada componente"
      - "É o mesmo conceito que o sistema de signals do framework Angular"
    correct: 1
---
