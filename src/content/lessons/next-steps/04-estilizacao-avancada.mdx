...
quiz:
  - question: "Qual é a principal vantagem do Tailwind CSS em relação ao CSS puro?"
    options:
      ...
      - "Tailwind gera CSS mais rápido de executar no browser"
      - "Tailwind funciona sem arquivos CSS"
      - "Tailwind tem melhor suporte a animações"
    correct: 0
  - question: "O que CSS Modules resolve que CSS global não resolve?"
    options:
      - "CSS Modules suportam variáveis; CSS global não"
      - "CSS Modules são mais rápidos de executar no browser"
      ...
      - "CSS Modules funcionam sem configuração extra"
    correct: 2
  - question: "Qual é o problema de styled-components em comparação com soluções build-time?"
    options:
      - "styled-components não suporta TypeScript"
      - "styled-components não suporta temas"
      - "styled-components é muito verboso"
  ...
  - question: "Quando faz sentido usar CSS global em vez de qualquer solução de escopo?"
    options:
      - "Nunca — CSS global sempre causa problemas"
      ...
      - "Apenas com frameworks como Next.js"
    correct: 1
---
