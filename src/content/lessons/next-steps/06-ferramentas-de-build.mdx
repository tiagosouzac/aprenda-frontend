...
quiz:
  - question: "O que uma ferramenta de build faz com o código TypeScript e JSX antes de entregar ao browser?"
    options:
      - "Transpila TS para JS e JSX para funções, resolve imports, junta tudo e minifica"
      - "Apenas executa o código uma vez e guarda o resultado em cache"
      - "Apenas verifica os tipos com o TypeScript, sem transformar o código"
      - "Apenas comprime os arquivos, sem modificar o conteúdo do código"
    correct: 0
  - question: "Por que o Vite é mais rápido no desenvolvimento que ferramentas baseadas em bundle??"
    options:
      - "Porque o Vite usa um compilador interno mais eficiente que as outras ferramentas"
      - "Porque o Vite escreve todo o bundle na memória RAM, e não em disco"
      - "Em dev, o Vite serve cada módulo via ESM nativo, sem fazer bundle de tudo antes"
      - "Porque o Vite distribui o trabalho de build entre várias threads da CPU"
    correct: 2
  - question: "O que é tree-shaking?"
    options:
      - "Uma técnica para otimizar e reduzir o tamanho das imagens da aplicação"
      - "Uma técnica para dividir o bundle em vários chunks carregados sob demanda"
      - "O processo de minificar o CSS, removendo espaços e comentários"
      - "Remove do bundle o código importado mas que nunca chega a ser usado (código morto)"
    correct: 3
  - question: "Quando você precisa se aprofundar em configuração de build?"
    options:
      - "Sempre — todo projeto acaba precisando de configuração personalizada"
      - "Quando há requisitos específicos: proxy de API, aliases, env por ambiente, otimizações"
      - "Só quando o projeto chega a ter mais de cem arquivos diferentes"
      - "Só quando o projeto está usando o webpack como ferramenta de build"
    correct: 1
---
