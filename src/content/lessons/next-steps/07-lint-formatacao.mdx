...
quiz:
  - question: "Qual é a diferença entre linting e formatação?"
    options:
      ...
      - "São a mesma coisa — dois nomes para o mesmo processo"
      - "Linting é para TypeScript; formatação é para CSS"
      - "Formatação é mais lenta que linting"
    correct: 0
  - question: "Por que vale configurar o strict mode do TypeScript em projetos novos?"
    options:
      - "Para que o TypeScript aceite mais sintaxes de JavaScript"
      - "Para acelerar a compilação do TypeScript"
      ...
      - "Para que o TypeScript funcione com React"
    correct: 2
  - question: "O que o Biome faz que ESLint + Prettier juntos fazem, mas em uma única ferramenta?"
    options:
      - "Apenas formatação — Biome não faz linting"
      - "Biome faz bundle além de lint e formatação"
      - "Biome só funciona com TypeScript"
  ...
  - question: "Por que é importante integrar ESLint/Biome ao CI além de ao editor?"
    options:
      - "Porque o editor pode não ter a extensão instalada"
      ...
      - "Porque o CI é mais rápido que o editor"
      - "Não é necessário — editor é suficiente"
    correct: 1
---
