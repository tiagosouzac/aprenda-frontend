...
quiz:
  - question: "O que o LCP (Largest Contentful Paint) mede?"
    options:
      ...
      - "O tempo até o primeiro pixel ser pintado no browser"
      - "O tempo total até todos os recursos da página carregarem"
      - "O número de elementos no DOM"
    correct: 0
  - question: "O que é CLS (Cumulative Layout Shift) e como evitá-lo?"
    options:
      - "O tempo de processamento do CSS pelo browser"
      - "O número de classes CSS aplicadas a um elemento"
      ...
      - "O tempo até o JavaScript terminar de executar"
    correct: 2
  - question: "O que é code splitting e por que ajuda na performance?"
    options:
      - "Uma técnica para dividir o código TypeScript em múltiplos arquivos"
      - "Minificar o código JavaScript para reduzir o tamanho"
      - "Separar o código de bibliotecas do código da aplicação"
  ...
  - question: "Por que servir imagens em WebP ou AVIF em vez de JPEG?"
    options:
      - "Porque JPEG não suporta transparência"
      ...
      - "Porque browsers antigos não suportam JPEG"
      - "Por questões de copyright — JPEG tem patentes"
    correct: 1
---
