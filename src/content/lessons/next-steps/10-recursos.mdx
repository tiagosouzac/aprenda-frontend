...
quiz:
  - question: "Por que a documentação oficial é preferível a tutoriais de terceiros para aprender uma tecnologia?"
    options:
      ...
      - "Porque os tutoriais feitos por terceiros, de modo geral, sempre acabam contendo algum tipo de erro técnico em algum ponto do conteúdo"
      - "Porque a grande maioria dos tutoriais de terceiros costuma ser paga, enquanto a documentação oficial das tecnologias é sempre gratuita"
      - "Porque a documentação oficial, de forma geral, costuma ser bem mais fácil e agradável de ler do que os tutoriais escritos por terceiros"
    correct: 0
  - question: "Qual é um sinal claro de que um tutorial de React está desatualizado?"
    options:
      - "O sinal mais claro é o tutorial usar o TypeScript no lugar do JavaScript puro nos exemplos de código que são apresentados ao longo dele"
      - "O sinal mais claro é o tutorial usar o npm como gerenciador de pacotes em vez de usar o yarn nos comandos de instalação que ele mostra"
      ...
      - "O sinal mais claro de que o tutorial está desatualizado é ele ter recebido um total de menos de dez mil visualizações na plataforma de vídeo"
    correct: 2
  - question: "Para que serve o MDN Web Docs especificamente?"
    options:
      - "É a documentação oficial da biblioteca React, mantida diretamente pela equipe que cuida do desenvolvimento dela atualmente no dia a dia"
      - "É um site cuja finalidade principal é permitir que qualquer pessoa publique os seus próprios tutoriais técnicos sobre programação web"
      - "É a documentação oficial do ambiente Node.js, com toda a referência das suas APIs e de todos os seus módulos internos disponíveis"
  ...
  - question: "O que o TypeScript Playground oferece que tutoriais normais não têm?"
    options:
      - "Oferece uma série de vídeos explicativos e bastante detalhados sobre como o TypeScript funciona por dentro em diferentes situações"
      ...
      - "Oferece uma grande coleção de exemplos prontos de código TypeScript, organizados por assunto, para que você apenas copie e cole no projeto"
      - "Oferece um curso completo e totalmente gratuito de TypeScript, indo desde o básico até os tópicos mais avançados da linguagem na prática"
    correct: 1
---
