...
quiz:
  - question: "Por que a documentação oficial é preferível a tutoriais de terceiros para aprender uma tecnologia?"
    options:
      - "É mantida por quem faz a tecnologia: sempre sincronizada com a versão atual"
      - "Porque os tutoriais de terceiros sempre acabam com algum erro técnico"
      - "Porque a maioria dos tutoriais é paga e a documentação é gratuita"
      - "Porque a documentação costuma ser mais fácil de ler que os tutoriais"
    correct: 0
  - question: "Qual é um sinal claro de que um tutorial de React está desatualizado?"
    options:
      - "Usar TypeScript no lugar do JavaScript puro nos exemplos de código"
      - "Usar o npm como gerenciador de pacotes em vez de usar o yarn"
      - "Usar class Component e componentDidMount — o React migrou para hooks em 2019"
      - "Ter recebido menos de dez mil visualizações na plataforma de vídeo"
    correct: 2
  - question: "Para que serve o MDN Web Docs especificamente?"
    options:
      - "É a documentação oficial da biblioteca React, mantida pela equipe dela"
      - "É um site para qualquer pessoa publicar tutoriais técnicos de programação"
      - "É a documentação oficial do Node.js, com a referência das suas APIs"
      - "A referência definitiva das plataformas web abertas: HTML, CSS e APIs do browser"
    correct: 3
  - question: "O que o TypeScript Playground oferece que tutoriais normais não têm?"
    options:
      - "Vídeos explicativos e detalhados sobre como o TypeScript funciona por dentro"
      - "Um ambiente que roda TS no browser com o compilador real, mostrando o JS gerado"
      - "Uma coleção de exemplos prontos de TypeScript para copiar e colar"
      - "Um curso completo e gratuito de TypeScript, do básico ao avançado"
    correct: 1
---
