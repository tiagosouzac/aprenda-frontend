...
quiz:
  - question: "O que diferencia um UI Engineer de um dev frontend convencional?"
    options:
      - "UI Engineers trabalham na interface entre design e engenharia — constroem sistemas de componentes, definem tokens de design, garantem consistência visual em escala, e frequentemente trabalham junto com designers para definir o que é implementável. É uma especialização que valoriza tanto a engenharia quanto o olho para design"
      - "Os UI Engineers são profissionais que trabalham exclusivamente com CSS no dia a dia, e não chegam a tocar em nenhuma outra parte do código"
      - "Os UI Engineers são, por definição da própria carreira, sempre profissionais mais sêniores do que os desenvolvedores frontend convencionais"
      - "Os UI Engineers são profissionais que, de modo geral, não costumam escrever nenhum tipo de teste automatizado para os componentes que constroem"
    correct: 0
  - question: "Por que React + TypeScript é o par mais pedido no mercado de trabalho frontend hoje?"
    options:
      - "Porque o React combinado com o TypeScript é, simplesmente, a tecnologia mais recente e mais nova de todas as que existem no mercado hoje"
      - "Porque o framework Next.js exige obrigatoriamente o uso do React em conjunto com o TypeScript para que ele consiga sequer funcionar"
      - "React ocupa a maior fatia do mercado de trabalho frontend há vários anos — a maioria dos produtos digitais em produção usa React. TypeScript virou padrão de fato em projetos profissionais porque detecta erros antes de rodar e torna o código mais navegável em equipe. A combinação é o mínimo esperado na maioria das vagas"
      - "Porque o React combinado com o TypeScript é, de longe, a combinação de tecnologias mais fácil de aprender para quem está apenas começando"
    correct: 2
  - question: "O que torna um projeto de portfólio mais valioso do que muitos projetos superficiais?"
    options:
      - "O que torna o projeto mais valioso é principalmente a quantidade total de tecnologias diferentes que estão listadas no README dele"
      - "O que torna o projeto mais valioso é o simples fato de ele usar a tecnologia mais nova e mais recente que estiver disponível no momento"
      - "O que torna o projeto mais valioso é ter uma quantidade bem grande de commits registrados ao longo de todo o histórico do git dele"
      - "Código limpo com estrutura clara, testes funcionando, deploy em produção (URL real que funciona), e um README que explica as decisões técnicas. Isso demonstra que você sabe não só escrever código mas também entregar, documentar, e sustentar um projeto"
    correct: 3
  - question: "Qual é o valor de contribuir para projetos open source como parte do desenvolvimento de carreira?"
    options:
      - "O principal valor de contribuir com open source é conseguir ter um repositório pessoal com uma quantidade bem grande de estrelas no GitHub"
      - "Contribuição open source expõe você a bases de código reais mantidas por equipes distribuídas — você lê código que não escreveu, submete mudanças sujeitas a revisão rigorosa, e aprende padrões de colaboração profissional. Também é visível no perfil do GitHub e aparece em conversas de processo seletivo"
      - "O principal valor de contribuir com open source é conseguir aprender a usar frameworks e bibliotecas novas de uma forma bem mais rápida"
      - "O principal valor de contribuir com open source é aumentar as chances de conseguir um emprego especificamente em empresas focadas em open source"
    correct: 1
---
