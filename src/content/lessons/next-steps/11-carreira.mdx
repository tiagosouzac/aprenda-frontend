...
quiz:
  - question: "O que diferencia um UI Engineer de um dev frontend convencional?"
    options:
      ...
      - "UI Engineers só trabalham com CSS"
      - "UI Engineers são mais sêniors que devs frontend"
      - "UI Engineers não escrevem testes"
    correct: 0
  - question: "Por que React + TypeScript é o par mais pedido no mercado de trabalho frontend hoje?"
    options:
      - "Porque é a tecnologia mais recente"
      - "Porque Next.js exige React e TypeScript"
      ...
      - "Porque é a combinação mais fácil de aprender"
    correct: 2
  - question: "O que torna um projeto de portfólio mais valioso do que muitos projetos superficiais?"
    options:
      - "O número de tecnologias listadas no README"
      - "Usar a tecnologia mais nova disponível"
      - "Ter muitos commits no histórico do git"
  ...
  - question: "Qual é o valor de contribuir para projetos open source como parte do desenvolvimento de carreira?"
    options:
      - "Para ter um repositório com muitas estrelas"
      ...
      - "Para aprender frameworks novos mais rápido"
      - "Para conseguir emprego em empresas de open source"
    correct: 1
---
