...
quiz:
  - question: "Qual é a diferença fundamental entre a abordagem imperativa (DOM puro) e a abordagem declarativa (React)?"
    options:
      ...
      - "React é mais rápido que DOM puro em todos os casos"
      - "React usa HTML diretamente; DOM puro usa JavaScript"
      - "Dom puro não suporta eventos; React sim"
    correct: 0
  - question: "O que é o virtual DOM?"
    options:
      - "Um DOM mais rápido fornecido pelos navegadores modernos"
      - "Um arquivo HTML separado mantido pelo React"
      ...
      - "Uma versão comprimida do DOM para mobile"
    correct: 2
  - question: "Por que a abordagem imperativa escala mal à medida que o estado cresce?"
    options:
      - "Porque o JavaScript fica mais lento com mais código"
      - "Porque o DOM tem um limite de elementos"
      - "Porque eventos não funcionam com estado complexo"
  ...
  - question: "O que é um componente React?"
    options:
      - "Um arquivo CSS separado para cada parte da UI"
      ...
      - "Uma classe que herda de React.Component"
      - "Um módulo JavaScript que manipula o DOM diretamente"
    correct: 1
---
