...
quiz:
  - question: "O que é JSX na prática?"
    options:
      ...
      - "Uma versão melhorada de HTML criada pelo Facebook"
      - "Um arquivo separado que descreve a estrutura visual"
      - "Uma linguagem de template que roda no servidor"
    correct: 0
  - question: "Por que class vira className em JSX?"
    options:
      - "Por convenção de estilo do React"
      - "Porque className é mais rápido de processar"
      ...
      - "Porque class só funciona em elementos HTML nativos"
    correct: 2
  - question: "Qual é o problema de usar {0 && <Componente />} para renderização condicional?"
    options:
      - "Não há problema — funciona corretamente"
      - "O componente é renderizado mesmo quando a condição é falsy"
      - "JSX não suporta o operador &&"
  ...
  - question: "Quando usar um fragmento (<>...</>) em vez de uma <div> como wrapper?"
    options:
      - "Sempre — fragmentos são mais rápidos"
      ...
      - "Apenas em listas"
      - "Fragmentos só funcionam em componentes de página"
    correct: 1
---
