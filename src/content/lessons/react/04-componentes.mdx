...
quiz:
  - question: "Por que componentes React têm nome em PascalCase?"
    options:
      ...
      - "Por convenção de estilo sem impacto técnico"
      - "Porque PascalCase melhora a performance"
      - "Por compatibilidade com TypeScript"
    correct: 0
  - question: "Por que named exports são preferíveis a default exports para componentes?"
    options:
      - "Porque default exports não funcionam em TypeScript"
      - "Porque named exports são mais rápidos"
      ...
      - "Porque o Vite não suporta default exports"
    correct: 2
  - question: "O que significa retornar null de um componente React?"
    options:
      - "Causa um erro — componentes devem sempre retornar JSX"
      - "O componente é removido da árvore de componentes"
      - "O componente renderiza um elemento vazio <span>"
  ...
  - question: "Qual é a vantagem de compor componentes pequenos em vez de um componente grande?"
    options:
      - "Componentes menores são mais rápidos"
      ...
      - "O React exige que componentes tenham menos de 100 linhas"
      - "Componentes menores usam menos memória"
    correct: 1
---
