...
quiz:
  - question: "Por que extends React.ButtonHTMLAttributes<HTMLButtonElement> é útil?"
    options:
      ...
      - "Para herdar o comportamento do botão"
      - "Para compatibilidade com versões antigas do React"
      - "Para que onClick funcione corretamente"
    correct: 0
  - question: "Qual é a diferença entre ReactNode e ReactElement?"
    options:
      - "São sinônimos — use qualquer um"
      - "ReactElement aceita null; ReactNode não"
      ...
      - "ReactNode é para componentes de classe; ReactElement é para componentes de função"
    correct: 2
  ...
  - question: "O que React.ComponentProps<'button'> retorna?"
    options:
      ...
      - "O tipo de retorno da função button"
      - "Um objeto com os métodos do button"
    correct: 1
---
