...
quiz:
  - question: "O que é um SyntheticEvent no React?"
    options:
      ...
      - "Um evento criado manualmente com new Event()"
      - "Um evento que não tem equivalente no DOM padrão"
      - "Um evento que só dispara em componentes de classe"
    correct: 0
  - question: "Qual é a diferença entre um formulário controlado e um não controlado?"
    options:
      - "Controlado usa HTML nativo; não controlado usa React"
      - "Formulários controlados são mais performáticos"
      ...
      - "Formulários não controlados não funcionam com TypeScript"
    correct: 2
  - question: "Por que event.preventDefault() é necessário em onSubmit de formulário?"
    options:
      - "Para impedir que outros handlers de evento sejam chamados"
      - "Para garantir que o estado seja atualizado antes do envio"
      - "Para que o TypeScript consiga tipar o evento corretamente"
  ...
  - question: "Quando faz sentido usar useRef em vez de um input controlado?"
    options:
      - "Sempre que possível — useRef é mais performático"
      ...
      - "useRef e inputs controlados são equivalentes — é só preferência"
      - "useRef não funciona com inputs de texto"
    correct: 1
---
