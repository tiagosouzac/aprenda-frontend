...
quiz:
  - question: "Qual das afirmações sobre keys em listas React está correta?"
    options:
      ...
      - "Keys são opcionais — React funciona sem elas"
      - "Keys devem ser únicas em toda a aplicação"
      - "Keys são passadas como prop para o componente filho"
    correct: 0
  - question: "Qual é a principal diferença entre usar useState local e Context?"
    options:
      - "Context é mais performático que useState"
      - "Context não pode ser usado com TypeScript"
      ...
      - "useState local não funciona com efeitos"
    correct: 2
  - question: "Por que os testes serão o próximo passo no curso?"
    options:
      - "Porque React não funciona sem testes"
      - "Porque o próximo módulo é sobre TypeScript"
      - "Testes são opcionais — o próximo passo é Next.js"
