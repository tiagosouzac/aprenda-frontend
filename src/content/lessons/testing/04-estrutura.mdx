...
quiz:
  - question: "O que representa cada etapa do padrão Arrange/Act/Assert?"
    options:
      - "Arrange é a etapa de escrever o teste, Act é a etapa de rodar o teste no terminal e Assert é a etapa de ler o resultado final dele"
      ...
      - "Arrange é a etapa de importar os módulos necessários, Act é a etapa de chamar as funções e Assert é a etapa de usar o expect no final"
      - "São, na verdade, três arquivos separados que ficam organizados dentro de um mesmo projeto de testes automatizados, em pastas distintas"
    correct: 1
  - question: "Por que o nome do teste importa?"
    options:
      ...
      - "Porque nomes de teste mais longos acabam deixando a execução de toda a suíte de testes do projeto perceptivelmente mais lenta no final"
      - "Porque o nome do teste serve apenas como uma forma de organização visual dos testes dentro da saída que é exibida no terminal ao rodar"
      - "Na verdade o nome do teste não tem nenhuma importância real: o que de fato importa em um teste é apenas o expect que está escrito nele"
    correct: 0
  - question: "Para que serve o beforeEach?"
    options:
      - "Serve para conseguir executar todos os testes daquele arquivo em paralelo entre si, o que acelera bastante a rodada completa da suíte"
      - "Serve para importar as dependências usadas no teste apenas quando elas forem realmente necessárias, economizando memória do processo"
      ...
      - "Serve para definir e controlar a ordem exata em que cada um dos testes daquele bloco describe vai acabar sendo executado pelo runner"
    correct: 2
  - question: "Quais são os três tipos de caso que uma boa suite de testes deve cobrir?"
    options:
      - "Os três tipos de caso são os testes considerados rápidos, os testes de velocidade média e os testes lentos dentro de uma suíte"
      - "Os três tipos de caso que se deve cobrir são os testes unitários, os testes de integração e os testes de ponta a ponta (E2E)"
      - "Os três tipos de caso são os testes síncronos, os testes assíncronos e os testes que verificam um componente isolado da interface"
