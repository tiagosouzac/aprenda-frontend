...
quiz:
  - question: "Por que funções puras são as mais fáceis de testar?"
    options:
      - "Porque elas são mais rápidas de executar"
      ...
      - "Porque o Vitest tem suporte especial para funções puras"
      - "Porque funções puras não podem lançar erros"
    correct: 1
  - question: "O que é test.each e quando usá-lo?"
    options:
      ...
      - "Uma forma de rodar testes em paralelo"
      - "Um matcher especial para arrays"
      - "Uma forma de pular testes condicionalmente"
    correct: 0
  - question: "Por que testar casos que parecem óbvios, como string vazia ou zero?"
    options:
      - "Por exigência de cobertura de código"
      - "Para aumentar o número de testes no relatório"
      ...
      - "Não é necessário — casos óbvios não precisam de teste"
    correct: 2
  - question: "Como testar uma função que depende de Date.now() de forma determinística?"
    options:
      - "Usar vi.mock para substituir Date"
      - "Usar setTimeout para controlar o tempo"
      - "Não é possível testar funções que dependem da hora atual"
