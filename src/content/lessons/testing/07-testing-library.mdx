...
quiz:
  - question: "Qual é a filosofia central da Testing Library?"
    options:
      - "Testar a implementação interna dos componentes para garantir que o estado correto é usado"
      ...
      - "Testar todos os hooks e estados do componente individualmente"
      - "Garantir 100% de cobertura de cada componente"
    correct: 1
  - question: "Por que getByRole é preferível a getByTestId?"
    options:
      ...
      - "getByTestId não funciona com Vitest"
      - "getByRole funciona com TypeScript; getByTestId não"
    correct: 0
  - question: "Qual a diferença entre getBy*, queryBy* e findBy*?"
    options:
      - "Apenas diferenças de performance"
      - "findBy* é mais preciso; getBy* é mais rápido"
      ...
      - "queryBy* só funciona com texto; getBy* funciona com qualquer seletor"
    correct: 2
  - question: "Por que usar userEvent.setup() em vez de fireEvent para simular interações?"
    options:
      - "userEvent é mais rápido que fireEvent"
      - "fireEvent não funciona com React 18"
      - "userEvent.setup() funciona com async/await; fireEvent não"
