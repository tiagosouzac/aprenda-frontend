...
quiz:
  - question: "O que diferencia um teste E2E de um teste de integração com jsdom?"
    options:
      - "Testes E2E são mais rápidos e precisos"
      ...
      - "E2E usa mocks; integração não"
      - "E2E testa apenas a UI; integração testa apenas o JavaScript"
    correct: 1
  - question: "Por que Playwright espera automaticamente antes de interagir com elementos?"
    options:
      ...
      - "Por limitação técnica — Playwright não consegue interagir sem esperar"
      - "Para simular conexões lentas de internet"
      - "É um comportamento opcional que pode ser desativado"
    correct: 0
  - question: "Por que getByRole é preferível a seletores CSS em testes E2E?"
    options:
      - "getByRole é mais rápido de executar no browser"
      - "Seletores CSS não funcionam com Playwright"
      ...
      - "getByRole é uma convenção sem impacto técnico"
    correct: 2
  - question: "O que deve ser testado com E2E em vez de testes de integração?"
    options:
      - "Toda lógica de negócio crítica"
