...
quiz:
  - question: "O que significa testar comportamento em vez de implementação?"
    options:
      - "Testar apenas a UI visível, não o JavaScript interno"
      ...
      - "Usar apenas testes E2E, que testam o comportamento real"
      - "Não testar funções internas, apenas APIs públicas"
    correct: 1
  - question: "Qual é o sinal mais claro de um teste frágil?"
    options:
      ...
      - "O teste leva mais de 1 segundo para rodar"
      - "O teste usa async/await"
      - "O teste tem mais de 10 linhas"
    correct: 0
  - question: "Por que 100% de cobertura de código não garante que o software funciona corretamente?"
    options:
      - "Porque ferramentas de cobertura têm bugs"
      - "Porque cobertura só funciona com testes unitários"
      ...
      - "Porque 100% é impossível na prática"
    correct: 2
  - question: "O que NÃO precisa de teste automatizado?"
    options:
      - "Funções que formatam dados"
