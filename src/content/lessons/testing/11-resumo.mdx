...
quiz:
  - question: "Qual é a proporção ideal na pirâmide de testes?"
    options:
      - "Igual para os três tipos — equilíbrio é sempre melhor"
      ...
      - "Apenas E2E — é o mais completo"
      - "Apenas unitários — são os mais rápidos"
    correct: 1
  - question: "O que o módulo de testes cobre que o de React não cobria?"
    options:
      ...
      - "Como usar React com TypeScript"
  ...
  - question: "Qual é o próximo passo natural após completar esse curso de fundamentos?"
    options:
      - "Aprender outra linguagem de programação"
      - "Aprofundar apenas em testes avançados"
      ...
      - "Começar a estudar mobile com React Native imediatamente"
    correct: 2
---
