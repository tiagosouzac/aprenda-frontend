...
quiz:
  - question: "O que acontece com os tipos TypeScript quando o código é compilado?"
    options:
      - "Eles são convertidos para comentários no JavaScript gerado"
      - "Eles são convertidos para verificações em runtime com if/throw"
      - "Eles ficam como metadados acessíveis em runtime via reflection"
  ...
  - question: "Por que TypeScript não detecta erros em dados que chegam de uma API?"
    options:
      ...
      - "Porque TypeScript não tem suporte a JSON"
