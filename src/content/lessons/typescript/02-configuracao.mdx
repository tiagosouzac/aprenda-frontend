...
quiz:
  - question: "O que strict: true no tsconfig.json habilita?"
    options:
      - "Apenas strictNullChecks"
      - "Apenas noImplicitAny"
      - "Verificações de performance em runtime"
  ...
  - question: "Por que noEmitOnError é recomendado?"
    options:
      ...
      - "Para reduzir o tamanho dos arquivos gerados"
    correct: 1
  - question: "Qual é a diferença entre target e module no tsconfig.json?"
    options:
      ...
      - "São sinônimos — qualquer um pode ser usado"
      - "target é para o navegador; module é para Node.js"
      - "target afeta os tipos; module afeta a sintaxe"
    correct: 0
  - question: "Por que usar tsc --noEmit no lugar de tsc para verificar tipos?"
    options:
      - "tsc --noEmit é mais rápido"
      - "tsc --noEmit é a única forma de compilar TypeScript"
      ...
      - "tsc --noEmit funciona sem tsconfig.json"
    correct: 2
---
