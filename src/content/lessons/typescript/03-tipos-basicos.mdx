...
quiz:
  - question: "Qual é a diferença entre any e unknown?"
    options:
      ...
      - "any é para objetos; unknown é para primitivos"
      - "unknown é depreciado em favor de any"
  ...
  - question: "Por que enums são geralmente evitados em TypeScript moderno?"
    options:
      - "Porque enums não funcionam com strict mode"
      ...
      - "Porque enums não podem ser usados em interfaces"
      - "Porque enums foram removidos no TypeScript 5"
    correct: 1
  - question: "O que é uma tupla em TypeScript?"
    options:
      ...
      - "Um array de objetos"
      - "Um tipo sinônimo de Record"
      - "Uma versão imutável de Array"
    correct: 0
