...
quiz:
  - question: "Qual é a diferença entre um parâmetro opcional (x?: string) e um com valor padrão (x: string = 'padrão')?"
    options:
      ...
      - "Parâmetro opcional é para strings; valor padrão é para numbers"
      - "Parâmetro com valor padrão não pode ser omitido na chamada"
  ...
  - question: "O que é um tipo de função em TypeScript?"
    options:
      ...
      - "Uma função que recebe tipos como argumento"
      - "Uma função definida com type em vez de function"
    correct: 1
  - question: "Quando o retorno de uma função é never em vez de void?"
    options:
      ...
      - "Quando a função não retorna um valor útil"
      - "Quando a função retorna null"
      - "never e void são intercambiáveis"
    correct: 0
  - question: "Por que desestruturar os parâmetros de uma função e anotar com uma interface é preferível a listar cada parâmetro individualmente?"
    options:
      - "Porque interfaces compilam mais rápido"
      - "Porque TypeScript não suporta mais de 4 parâmetros"
      ...
      - "Porque desestruturação é obrigatória com strict mode"
    correct: 2
---
