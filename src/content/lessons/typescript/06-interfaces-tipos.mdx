...
quiz:
  - question: "Qual é a principal diferença prática entre interface e type para descrever objetos?"
    options:
      - "interface é mais rápida em compilação"
      - "type só pode ser usado para primitivos"
  ...
  - question: "O que é declaração merging em interfaces?"
    options:
      - "Combinar dois arquivos TypeScript em um"
      ...
      - "Exportar uma interface de dois módulos diferentes"
      - "Criar uma interface que herda de outra"
    correct: 1
  - question: "Quando usar type em vez de interface?"
    options:
      ...
      - "Sempre — type é superior"
      - "Apenas para tipos primitivos"
      - "Apenas em arquivos .d.ts"
    correct: 0
  - question: "Como readonly difere de const para propriedades de objetos?"
    options:
      - "readonly e const são equivalentes para objetos"
      - "readonly é para arrays; const é para objetos"
      ...
      - "readonly funciona apenas em classes"
    correct: 2
---
