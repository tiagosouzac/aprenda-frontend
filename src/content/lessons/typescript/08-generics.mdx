...
quiz:
  - question: "Por que generics existem?"
    options:
      - "Para substituir interfaces"
      - "Para criar tipos dinâmicos em runtime"
      - "Para substituir unions"
  ...
  - question: "Quando TypeScript infere o parâmetro de tipo automaticamente?"
    options:
      ...
      - "Nunca — sempre precisa ser passado explicitamente"
      - "Apenas em funções arrow"
      - "Apenas quando há um único parâmetro de tipo"
    correct: 0
  - question: "Qual é a diferença entre uma função genérica e uma função que aceita any?"
    options:
      - "Não há diferença prática"
      - "any é mais rápido em runtime"
      ...
      - "Funções genéricas só funcionam com arrays"
    correct: 2
---
