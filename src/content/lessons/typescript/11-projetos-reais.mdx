...
quiz:
  - question: "Por que TypeScript não detecta quando uma API retorna dados com formato diferente do esperado?"
    options:
      - "Porque TypeScript não suporta fetch"
      - "Porque APIs sempre retornam any"
      - "Porque fetch não é suportado pelo compilador TypeScript"
  ...
  - question: "O que as const faz a um objeto literal?"
    options:
      - "Torna o objeto imutável em runtime — como Object.freeze()"
      ...
      - "Converte o objeto para um enum"
      - "Remove o objeto do output JavaScript"
    correct: 1
  - question: "O que é um arquivo .d.ts?"
    options:
      ...
      - "Um arquivo de configuração do TypeScript"
      - "Um arquivo de definição de rotas"
      - "Um arquivo de dados JSON tipado"
    correct: 0
  - question: "Qual é a diferença entre any e unknown quando você recebe dados de uma API?"
    options:
      - "Não há diferença na prática"
      - "unknown é apenas para funções"
      ...
      - "any é preferível para dados de API"
    correct: 2
---
